...
function MeusEventosHost() {
    ...
    const [isArtista, setIsArtista] = useState(false); // Novo estado para Artista
    const [artistaIdLogado, setArtistaIdLogado] = useState(null); // Novo estado para ID do artista
    ...
    const [meusContratosArtista, setMeusContratosArtista] = useState([]); // Novo estado para contratos do artista
    ...
    // Nova função para buscar contratos do artista pelo ID do artista
    ...
    }, [fetchMinhasReservas, fetchReservasPorEvento, fetchMeusContratosArtista]);
