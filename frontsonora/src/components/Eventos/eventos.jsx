...
const Eventos = () => {
    const eventos = [
        { id: 1, titulo: "Indaiatuba Festival", local: "Indaiatuba", hora: "19:00", imagem: "../../../public/evento1.png" },
        { id: 2, titulo: "Boom Bap Fest", local: "Campinas", hora: "20:00", imagem: "../../../public/evento2.png" },
