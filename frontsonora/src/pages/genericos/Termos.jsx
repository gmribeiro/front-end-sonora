  ...
  return (
    ...
    >
      ...
      <button
        ...
        className="absolute bottom-4 right-4 bg-[#564A72] text-white px-5 py-2 sm:px-6 sm:py-3 rounded-md hover:bg-[#ab8feb] focus:outline-none focus:ring-2 focus:ring-[#ab8feb] transition-all duration-200"
