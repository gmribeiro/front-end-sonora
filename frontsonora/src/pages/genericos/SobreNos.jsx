  ...
  return (
    <>
      <main className="bg-[#EDE6F2] font-serif !text-[#ab8feb] leading-relaxed min-h-screen">
        ...
        <section className="px-[8%] py-16 !text-[#ab8feb]">
          <p className="text-[1.1rem] mb-4 first-letter:text-2xl first-letter:font-bold first-letter:!text-[#ab8feb] first-letter:mr-1 first-letter:float-left first-letter:leading-none !text-[#ab8feb]">
          ...
          <p className="text-[1.1rem] mb-4 !text-[#ab8feb]">
          ...
          <div className="flex justify-end">
            <button
              className="mt-8 px-6 py-2 bg-[#ab8feb] text-white hover:bg-[#564A72] transition"
